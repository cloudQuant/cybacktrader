...
try:
    ...
    # Plotting not available without pyecharts
...
from cybacktrader.formatters import (MyVolFormatter, MyDateFormatter, getlocator)
from cybacktrader import locator as loc
from cybacktrader.multicursor import MultiCursor
from cybacktrader.scheme import PlotScheme
from cybacktrader.utils import tag_box_style
