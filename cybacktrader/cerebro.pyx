...
from cybacktrader import observers
from cybacktrader.writer import WriterFile
from cybacktrader.utils import OrderedDict, tzparse, num2date, date2num
from cybacktrader.strategy import Strategy, SignalStrategy
from cybacktrader.tradingcal import (TradingCalendarBase, TradingCalendar,
...
class Cerebro(with_metaclass(MetaParams, object)):
    ...
    def runstrategies(self, iterstrat, predata=False):
        ...
        for stratcls, sargs, skwargs in iterstrat:
            ...
            # 实例化策略
            # Pass cerebro explicitly for Cython compatibility
            skwargs['_cerebro'] = self
            try:
