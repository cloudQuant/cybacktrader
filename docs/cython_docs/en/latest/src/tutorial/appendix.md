...
Appendix: Installing MinGW on Windows — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/tutorial/appendix.html "/en/stable/src/tutorial/appendix.html").

### Navigation

* [next](../userguide/index.html "Users Guide")
* [previous](related_work.html "Related work") |
...
# Appendix: Installing MinGW on Windows[¶](#appendix-installing-mingw-on-windows "Link to this heading")

1. Download the MinGW installer from
   [https://www.mingw.org/wiki/HOWTO\_Install\_the\_MinGW\_GCC\_Compiler\_Suite](https://www.mingw.org/wiki/HOWTO_Install_the_MinGW_GCC_Compiler_Suite "https://www.mingw.org/wiki/HOWTO_Install_the_MinGW_GCC_Compiler_Suite").
   (As of this
...
3. You need to set up Windows’ “PATH” environment variable so that
   ...
   [https://support.microsoft.com/kb/310519](https://support.microsoft.com/kb/310519 "https://support.microsoft.com/kb/310519")
...
The [[WinInst]](#wininst "#wininst") wiki page contains updated information about this
...
## Python 3.8+[¶](#python-3-8 "Link to this heading")

Since Python 3.8, the search paths of DLL dependencies has been reset.
([changelog](https://docs.python.org/3/whatsnew/3.8.html#bpo-36085-whatsnew "https://docs.python.org/3/whatsnew/3.8.html#bpo-36085-whatsnew"))

Only the system paths, the directory containing the DLL or PYD file
are searched for load-time dependencies.
Instead, a new function [os.add\_dll\_directory()](https://docs.python.org/3.8/library/os.html#os.add_dll_directory "https://docs.python.org/3.8/library/os.html#os.add_dll_directory")
...
[https://github.com/cython/cython/wiki/CythonExtensionsOnWindows](https://github.com/cython/cython/wiki/CythonExtensionsOnWindows "https://github.com/cython/cython/wiki/CythonExtensionsOnWindows")
...
[Related work](related_work.html "previous chapter")

#### Next topic

[Users Guide](../userguide/index.html "next chapter")

### This Page

* [Show Source](../../_sources/src/tutorial/appendix.rst.txt "../../_sources/src/tutorial/appendix.rst.txt")
