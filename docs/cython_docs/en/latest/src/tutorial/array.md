...
Working with Python arrays — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/tutorial/array.html "/en/stable/src/tutorial/array.html").

### Navigation

* [next](parallelization.html "Writing parallel code with Cython")
* [previous](numpy.html "Working with NumPy") |
...
# Working with Python arrays[¶](#working-with-python-arrays "Link to this heading")
...
[`multiprocessing`](https://docs.python.org/3/library/multiprocessing.html#module-multiprocessing "(in Python v3.14)").
...
Numpy array there is no need to install a dependency, as the [`array`](https://docs.python.org/3/library/array.html#module-array "(in Python v3.14)")
module is built into both Python and Cython.

## Safe usage with memory views[¶](#safe-usage-with-memory-views "Link to this heading")
...
documentation for the [array module](https://docs.python.org/library/array.html "https://docs.python.org/library/array.html").
...
## Zero-overhead, unsafe access to raw C pointer[¶](#zero-overhead-unsafe-access-to-raw-c-pointer "Link to this heading")
...
## Cloning, extending arrays[¶](#cloning-extending-arrays "Link to this heading")
...
### Data fields[¶](#data-fields "Link to this heading")
...
* [Working with Python arrays](# "#")
  + [Safe usage with memory views](#safe-usage-with-memory-views "#safe-usage-with-memory-views")
  + [Zero-overhead, unsafe access to raw C pointer](#zero-overhead-unsafe-access-to-raw-c-pointer "#zero-overhead-unsafe-access-to-raw-c-pointer")
  + [Cloning, extending arrays](#cloning-extending-arrays "#cloning-extending-arrays")
...
[Working with NumPy](numpy.html "previous chapter")

#### Next topic

[Writing parallel code with Cython](parallelization.html "next chapter")

### This Page

* [Show Source](../../_sources/src/tutorial/array.rst.txt "../../_sources/src/tutorial/array.rst.txt")
