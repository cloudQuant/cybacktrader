...
Using C libraries — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/tutorial/clibraries.html "/en/stable/src/tutorial/clibraries.html").

### Navigation

* [next](cdef_classes.html "Extension types (aka. cdef classes)")
* [previous](external.html "Calling C functions") |
...
# Using C libraries[¶](#using-c-libraries "Link to this heading")
...
After some web search, you find the C-algorithms library [[CAlg]](#calg "#calg") and
...
Simon Howard, C Algorithms library, [https://fragglet.github.io/c-algorithms/](https://fragglet.github.io/c-algorithms/ "https://fragglet.github.io/c-algorithms/")

## Defining external declarations[¶](#defining-external-declarations "Link to this heading")

You can download CAlg [here](https://codeload.github.com/fragglet/c-algorithms/zip/master "https://codeload.github.com/fragglet/c-algorithms/zip/master").
...
cqueue.pxd[¶](#id10 "Link to this code")
...
## Writing a wrapper class[¶](#writing-a-wrapper-class "Link to this heading")
...
queue.py[¶](#id11 "Link to this code")
...
queue.pyx[¶](#id12 "Link to this code")
...
The Python way to get out of this is to raise a `MemoryError` [[3]](#id8 "#id8").
We can thus change the init function as follows:

Pure PythonCython

queue.py[¶](#id13 "Link to this code")
...
queue.pyx[¶](#id14 "Link to this code")
...
## Compiling and linking[¶](#compiling-and-linking "Link to this heading")
...
### Static Linking[¶](#static-linking "Link to this heading")
...
### Dynamic Linking[¶](#dynamic-linking "Link to this heading")
...
### Mapping functionality[¶](#mapping-functionality "Link to this heading")
...
Here, [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.14)"):
...
to a smaller integer type without checking the boundaries, and [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.14)")
...
an `int`, so the above conversion from void\* to [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.14)") to `int`
(the return type) is safe by design.

### Handling errors[¶](#handling-errors "Link to this heading")
...
[`PyErr_Occurred()`](https://docs.python.org/3/c-api/exceptions.html#c.PyErr_Occurred "(in Python v3.14)") when returning from a function to check if an
...
values. See [Error return values](../userguide/language_basics.html#error-return-values "../userguide/language_basics.html#error-return-values") for more details.
...
### Testing the result[¶](#testing-the-result "Link to this heading")
...
queue.py[¶](#id15 "Link to this code")
...
queue.pyx[¶](#id16 "Link to this code")
...
for example here `test_queue.py`:
...
* [Using C libraries](# "#")
  + [Defining external declarations](#defining-external-declarations "#defining-external-declarations")
  + [Writing a wrapper class](#writing-a-wrapper-class "#writing-a-wrapper-class")
  + [Memory management](#memory-management "#memory-management")
  + [Compiling and linking](#compiling-and-linking "#compiling-and-linking")
    - [Static Linking](#static-linking "#static-linking")
    - [Dynamic Linking](#dynamic-linking "#dynamic-linking")
    - [Mapping functionality](#mapping-functionality "#mapping-functionality")
    - [Handling errors](#handling-errors "#handling-errors")
    - [Testing the result](#testing-the-result "#testing-the-result")
    - [Callbacks](#callbacks "#callbacks")

#### Previous topic

[Calling C functions](external.html "previous chapter")

#### Next topic

[Extension types (aka. cdef classes)](cdef_classes.html "next chapter")

### This Page

* [Show Source](../../_sources/src/tutorial/clibraries.rst.txt "../../_sources/src/tutorial/clibraries.rst.txt")
