...
Calling C functions — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/tutorial/external.html "/en/stable/src/tutorial/external.html").

### Navigation

* [next](clibraries.html "Using C libraries")
* [previous](cython_tutorial.html "Basic Tutorial") |
...
and handling errors, see [Using C libraries](clibraries.html "clibraries.html").
...
atoi.pyx[¶](#id2 "Link to this code")
...
[Cython/Includes/](https://github.com/cython/cython/tree/master/Cython/Includes "https://github.com/cython/cython/tree/master/Cython/Includes").
They are stored in `.pxd` files, the standard way to provide reusable
Cython declarations that can be shared across modules
(see [Sharing Declarations Between Cython Modules](../userguide/sharing_declarations.html#sharing-declarations "../userguide/sharing_declarations.html#sharing-declarations")).
...
py\_version\_hex.py[¶](#id3 "Link to this code")
...
py\_version\_hex.pyx[¶](#id4 "Link to this code")
...
libc\_sin.py[¶](#id5 "Link to this code")
...
libc\_sin.pyx[¶](#id6 "Link to this code")
...
## Naming parameters[¶](#naming-parameters "Link to this heading")
...
keyword\_args\_call.py[¶](#id7 "Link to this code")
...
strstr.pxd[¶](#id8 "Link to this code")
...
keyword\_args\_call.pyx[¶](#id9 "Link to this code")
...
* [Calling C functions](# "#")
  ...
  + [Naming parameters](#naming-parameters "#naming-parameters")

#### Previous topic

[Basic Tutorial](cython_tutorial.html "previous chapter")

#### Next topic

[Using C libraries](clibraries.html "next chapter")

### This Page

* [Show Source](../../_sources/src/tutorial/external.rst.txt "../../_sources/src/tutorial/external.rst.txt")
