...
Embedding Cython modules in C/C++ applications — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/tutorial/embedding.html "/en/stable/src/tutorial/embedding.html").
...
The [`PyImport_AppendInittab()`](https://docs.python.org/3/c-api/import.html#c.PyImport_AppendInittab "(in Python v3.14)")
