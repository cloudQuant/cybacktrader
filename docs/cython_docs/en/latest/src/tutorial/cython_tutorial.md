...
Basic Tutorial — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/tutorial/cython_tutorial.html "/en/stable/src/tutorial/cython_tutorial.html").

### Navigation

* [next](external.html "Calling C functions")
* [previous](index.html "Tutorials") |
...
# Basic Tutorial[¶](#basic-tutorial "Link to this heading")
...
## The Basics of Cython[¶](#the-basics-of-cython "Link to this heading")
...
(There are a few [Limitations](../userguide/limitations.html#cython-limitations "../userguide/limitations.html#cython-limitations"), but this approximation will
...
declared to have C data types. Code which manipulates [Python values](../userguide/glossary.html#term-Python-object "../userguide/glossary.html#term-Python-object") and C
...
## Cython Hello World[¶](#cython-hello-world "Link to this heading")
...
see [Source Files and Compilation](../userguide/source_files_and_compilation.html#compilation "../userguide/source_files_and_compilation.html#compilation")). Your `setup.py` should look like:
...
## Fibonacci Fun[¶](#fibonacci-fun "Link to this heading")
...
## Primes[¶](#primes "Link to this heading")
...
primes.py[¶](#id2 "Link to this code")
...
primes.pyx[¶](#id3 "Link to this code")
...
they are allocated on the C function call [stack](../userguide/glossary.html#term-Stack-allocation "../userguide/glossary.html#term-Stack-allocation"),
...
[C memory allocation](memory_allocation.html#memory-allocation "memory_allocation.html#memory-allocation"),
[Python arrays](array.html#array-array "array.html#array-array")
or [NumPy arrays](../userguide/memoryviews.html#memoryviews "../userguide/memoryviews.html#memoryviews") with Cython.
...
[Python documentation](https://docs.python.org/3/tutorial/controlflow.html#else-clauses-on-loops "https://docs.python.org/3/tutorial/controlflow.html#else-clauses-on-loops")
...
documentation on [type conversion](../userguide/language_basics.html#type-conversion "../userguide/language_basics.html#type-conversion"), so we can use
...
[![../../_images/htmlreport_py1.png](../../_images/htmlreport_py1.png)](../../_images/htmlreport_py1.png "../../_images/htmlreport_py1.png")

[![../../_images/htmlreport_pyx1.png](../../_images/htmlreport_pyx1.png)](../../_images/htmlreport_pyx1.png "../../_images/htmlreport_pyx1.png")
...
[compiler directives](../userguide/source_files_and_compilation.html#compiler-directives "../userguide/source_files_and_compilation.html#compiler-directives").
...
primes\_python.py / primes\_python\_compiled.py[¶](#id4 "Link to this code")
...
## Primes with C++[¶](#primes-with-c "Link to this heading")
...
[vector](https://en.cppreference.com/w/cpp/container/vector "https://en.cppreference.com/w/cpp/container/vector")
...
see [this page from cppreference](https://en.cppreference.com/w/cpp/container/vector "https://en.cppreference.com/w/cpp/container/vector").
...
For more details about using C++ with Cython, see [Using C++ in Cython](../userguide/wrapping_CPlusPlus.html#wrapping-cplusplus "../userguide/wrapping_CPlusPlus.html#wrapping-cplusplus").

## Language Details[¶](#language-details "Link to this heading")

For more about the Cython language, see [Language Basics](../userguide/language_basics.html#language-basics "../userguide/language_basics.html#language-basics").
To dive right in to using Cython in a numerical computation context,
see [Typed Memoryviews](../userguide/memoryviews.html#memoryviews "../userguide/memoryviews.html#memoryviews").
...
* [Basic Tutorial](# "#")
  + [The Basics of Cython](#the-basics-of-cython "#the-basics-of-cython")
  + [Cython Hello World](#cython-hello-world "#cython-hello-world")
  + [Fibonacci Fun](#fibonacci-fun "#fibonacci-fun")
  + [Primes](#primes "#primes")
  + [Primes with C++](#primes-with-c "#primes-with-c")
  + [Language Details](#language-details "#language-details")

#### Previous topic

[Tutorials](index.html "previous chapter")

#### Next topic

[Calling C functions](external.html "next chapter")

### This Page

* [Show Source](../../_sources/src/tutorial/cython_tutorial.rst.txt "../../_sources/src/tutorial/cython_tutorial.rst.txt")
