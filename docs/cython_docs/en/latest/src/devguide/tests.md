...
The Test Suite — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/devguide/tests.html "/en/stable/src/devguide/tests.html").

### Navigation

* [next](../changes.html "Cython Changelog")
* [previous](cython_internals.html "Cython internals") |
...
# The Test Suite[¶](#the-test-suite "Link to this heading")

A very good place to start understanding Cython is the [test suite](https://github.com/cython/cython/tree/master/tests/ "https://github.com/cython/cython/tree/master/tests/"),
which lives in the “tests” directory of the source repository. The tests (collected and run by
[runtests.py](https://github.com/cython/cython/blob/master/runtests.py "https://github.com/cython/cython/blob/master/runtests.py"))
mostly use the [doctest module](https://docs.python.org/3/library/doctest.html "https://docs.python.org/3/library/doctest.html") of Python.
...
## Parse tree assertions[¶](#parse-tree-assertions "Link to this heading")
...
The [TestTreePath module](https://github.com/cython/cython/blob/master/Cython/Compiler/Tests/TestTreePath.py "https://github.com/cython/cython/blob/master/Cython/Compiler/Tests/TestTreePath.py")
...
## Running the CPython test suite[¶](#running-the-cpython-test-suite "Link to this heading")
...
## Tip to create doctest scripts[¶](#tip-to-create-doctest-scripts "Link to this heading")
...
## Debugging failures in the Cython test suite[¶](#debugging-failures-in-the-cython-test-suite "Link to this heading")
...
* [The Test Suite](# "#")
  + [Tags](#tags "#tags")
  + [Tests](#tests "#tests")
  + [Parse tree assertions](#parse-tree-assertions "#parse-tree-assertions")
  + [Running the CPython test suite](#running-the-cpython-test-suite "#running-the-cpython-test-suite")
  + [Tip to create doctest scripts](#tip-to-create-doctest-scripts "#tip-to-create-doctest-scripts")
  + [Debugging failures in the Cython test suite](#debugging-failures-in-the-cython-test-suite "#debugging-failures-in-the-cython-test-suite")

#### Previous topic

[Cython internals](cython_internals.html "previous chapter")

#### Next topic

[Cython Changelog](../changes.html "next chapter")

### This Page

* [Show Source](../../_sources/src/devguide/tests.rst.txt "../../_sources/src/devguide/tests.rst.txt")
