...
Debugging your Cython program — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/debugging.html "/en/stable/src/userguide/debugging.html").

### Navigation

* [next](numpy_tutorial.html "Cython for NumPy users")
* [previous](parallelism.html "Using Parallelism") |
...
# Debugging your Cython program[¶](#debugging-your-cython-program "Link to this heading")
...
Installing the Cython debugger can be quite tricky. [This installation script and example code](https://gitlab.com/volkerweissmann/cygdb_installation "https://gitlab.com/volkerweissmann/cygdb_installation") might be useful.
...
## Running the Debugger[¶](#running-the-debugger "Link to this heading")
...
see an [import error for multiarray](https://bugzilla.redhat.com/show_bug.cgi?id=1030830 "https://bugzilla.redhat.com/show_bug.cgi?id=1030830").
E.G. for ubuntu:
...
## Using the Debugger[¶](#using-the-debugger "Link to this heading")
...
cy\_cname(varname)[¶](#cy_cname "Link to this definition")

Returns the C variable name of a Cython variable. For global
variables this may not be actually valid.

cy\_cvalue(varname)[¶](#cy_cvalue "Link to this definition")

Returns the value of a Cython variable.

cy\_eval(expression)[¶](#cy_eval "Link to this definition")
...
cy\_lineno()[¶](#cy_lineno "Link to this definition")
...
## Configuring the Debugger[¶](#configuring-the-debugger "Link to this heading")
...
cy\_complete\_unqualified[¶](#c.cy_complete_unqualified "Link to this definition")
...
cy\_colorize\_code[¶](#c.cy_colorize_code "Link to this definition")

Tells the debugger whether to colorize source code. The default is true.

cy\_terminal\_background\_color[¶](#c.cy_terminal_background_color "Link to this definition")
...
* [Debugging your Cython program](# "#")
  + [Running the Debugger](#running-the-debugger "#running-the-debugger")
  + [Using the Debugger](#using-the-debugger "#using-the-debugger")
  + [Convenience functions](#convenience-functions "#convenience-functions")
    - [`cy_cname()`](#cy_cname "#cy_cname")
    - [`cy_cvalue()`](#cy_cvalue "#cy_cvalue")
    - [`cy_eval()`](#cy_eval "#cy_eval")
    - [`cy_lineno()`](#cy_lineno "#cy_lineno")
  + [Configuring the Debugger](#configuring-the-debugger "#configuring-the-debugger")

#### Previous topic

[Using Parallelism](parallelism.html "previous chapter")

#### Next topic

[Cython for NumPy users](numpy_tutorial.html "next chapter")

### This Page

* [Show Source](../../_sources/src/userguide/debugging.rst.txt "../../_sources/src/userguide/debugging.rst.txt")
