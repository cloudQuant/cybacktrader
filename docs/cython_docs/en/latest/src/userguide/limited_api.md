...
The Limited API and Stable ABI — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/limited_api.html "/en/stable/src/userguide/limited_api.html").

### Navigation

* [next](migrating_to_cy30.html "Migrating from Cython 0.29 to 3.0")
* [previous](pypy.html "Porting Cython code to PyPy") |
...
# The Limited API and Stable ABI[¶](#the-limited-api-and-stable-abi "Link to this heading")

The Limited API and Stable ABI are [two related features of Python](https://docs.python.org/3/c-api/stable.html "https://docs.python.org/3/c-api/stable.html"). Extension modules that only use a safe subset of the Python C API (the Limited API)
...
* Some features only work on specific versions of the Limited API. The most significant is
  [Typed Memoryviews](memoryviews.html#memoryviews "memoryviews.html#memoryviews") which requires Python 3.11+ in Limited API mode.
...
## Building with the Limited API[¶](#building-with-the-limited-api "Link to this heading")
...
### Setuptools and setup.py[¶](#setuptools-and-setup-py "Link to this heading")

Using setup.py to control the compilation (as shown in the main [Source Files and Compilation](source_files_and_compilation.html#compilation "source_files_and_compilation.html#compilation")
documentation):
...
[Scikit-build](https://scikit-build.readthedocs.io "https://scikit-build.readthedocs.io") uses CMake to control compilation:
...
[their own documentation](https://scikit-build.readthedocs.io/en/latest/cmake-modules/Cython.html "https://scikit-build.readthedocs.io/en/latest/cmake-modules/Cython.html")
...
### Meson[¶](#meson "Link to this heading")

[Meson](https://mesonbuild.com/ "https://mesonbuild.com/") is another modern build system that can be used
...
[the Meson documentation](https://mesonbuild.com/Cython.html#cython "https://mesonbuild.com/Cython.html#cython") and more complete
...
* [The Limited API and Stable ABI](# "#")
  ...
  + [Building with the Limited API](#building-with-the-limited-api "#building-with-the-limited-api")
    - [Setuptools and setup.py](#setuptools-and-setup-py "#setuptools-and-setup-py")
    - [Scikit-build](#scikit-build "#scikit-build")
    - [Meson](#meson "#meson")

#### Previous topic

[Porting Cython code to PyPy](pypy.html "previous chapter")

#### Next topic

[Migrating from Cython 0.29 to 3.0](migrating_to_cy30.html "next chapter")

### This Page

* [Show Source](../../_sources/src/userguide/limited_api.rst.txt "../../_sources/src/userguide/limited_api.rst.txt")
