...
Free threading — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/freethreading.html "/en/stable/src/userguide/freethreading.html").

### Navigation

* [next](tempita.html "Tempita templating language")
* [previous](nogil.html "Cython and the GIL") |
...
# Free threading[¶](#free-threading "Link to this heading")
...
* [PEP 703](https://peps.python.org/pep-0703/ "https://peps.python.org/pep-0703/") - the initial proposal that lead
  to this feature existing in Python.
* [Python documentation for free-threaded extensions](https://docs.python.org/3.13/howto/free-threading-extensions.html "https://docs.python.org/3.13/howto/free-threading-extensions.html").
* [Quansight labs’ documentation of the status of free-threading](https://py-free-threading.github.io/ "https://py-free-threading.github.io/").
...
## Tools for Thread-safety[¶](#tools-for-thread-safety "Link to this heading")
...
[Critical Sections](https://docs.python.org/3.13/c-api/init.html#python-critical-section-api "https://docs.python.org/3.13/c-api/init.html#python-critical-section-api")
...
### Locks[¶](#locks "Link to this heading")
...
[PyMutex](https://docs.python.org/3.13/c-api/init.html#synchronization-primitives "https://docs.python.org/3.13/c-api/init.html#synchronization-primitives")
...
### Building on Windows[¶](#building-on-windows "Link to this heading")
...
[Don’t use the GIL as a lock](nogil.html#gil-as-lock "nogil.html#gil-as-lock").

## Opinionated Suggestions[¶](#opinionated-suggestions "Link to this heading")
...
### Interaction between threads[¶](#interaction-between-threads "Link to this heading")
...
### Should you use `prange`?[¶](#should-you-use-prange "Link to this heading")
...
### Try to avoid Python code in `prange`[¶](#try-to-avoid-python-code-in-prange "Link to this heading")
...
### Use C++ for low-level synchronization primitives[¶](#use-c-for-low-level-synchronization-primitives "Link to this heading")
...
In addition to the plain standard library features, Cython (3.2) also produces “py\_safe” versions
...
The “py\_safe” functions are only effective if you use
them consistently every time you try to acquire the lock while you might be holding the Python
thread-state. This means you should use the “py\_safe” versions even in a function labelled
...
### `cython.critical_section` vs GIL[¶](#cython-critical-section-vs-gil "Link to this heading")
...
### Avoid `cython.critical_section` on non-extension types[¶](#avoid-cython-critical-section-on-non-extension-types "Link to this heading")
...
* [Free threading](# "#")
  ...
  + [Tools for Thread-safety](#tools-for-thread-safety "#tools-for-thread-safety")
    - [Critical Sections](#critical-sections "#critical-sections")
    - [Locks](#locks "#locks")
  + [Pitfalls](#pitfalls "#pitfalls")
    - [Building on Windows](#building-on-windows "#building-on-windows")
    - [Thread safety](#thread-safety "#thread-safety")
  + [Opinionated Suggestions](#opinionated-suggestions "#opinionated-suggestions")
    - [Interaction between threads](#interaction-between-threads "#interaction-between-threads")
    - [Should you use `prange`?](#should-you-use-prange "#should-you-use-prange")
    - [Try to avoid Python code in `prange`](#try-to-avoid-python-code-in-prange "#try-to-avoid-python-code-in-prange")
    - [Use C++ for low-level synchronization primitives](#use-c-for-low-level-synchronization-primitives "#use-c-for-low-level-synchronization-primitives")
    - [`cython.critical_section` vs GIL](#cython-critical-section-vs-gil "#cython-critical-section-vs-gil")
    - [Avoid `cython.critical_section` on non-extension types](#avoid-cython-critical-section-on-non-extension-types "#avoid-cython-critical-section-on-non-extension-types")

#### Previous topic

[Cython and the GIL](nogil.html "previous chapter")

#### Next topic

[Tempita templating language](tempita.html "next chapter")

### This Page

* [Show Source](../../_sources/src/userguide/freethreading.rst.txt "../../_sources/src/userguide/freethreading.rst.txt")
