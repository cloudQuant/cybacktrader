...
Early Binding for Speed — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/early_binding_for_speed.html "/en/stable/src/userguide/early_binding_for_speed.html").
