...
Troubleshooting — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/troubleshooting.html "/en/stable/src/userguide/troubleshooting.html").

### Navigation

* [next](faq.html "FAQ")
* [previous](tempita.html "Tempita templating language") |
...
## Where the language is “messy”[¶](#where-the-language-is-messy "Link to this heading")
...
### Untyped objects[¶](#untyped-objects "Link to this heading")
...
### Writing into extension types[¶](#writing-into-extension-types "Link to this heading")
...
## Extension type class attributes vs instance attributes[¶](#extension-type-class-attributes-vs-instance-attributes "Link to this heading")
...
## Pitfalls of automatic type conversions[¶](#pitfalls-of-automatic-type-conversions "Link to this heading")
...
* C++ standard library containers
  [to/from their Python equivalent](wrapping_CPlusPlus.html#stl-types "wrapping_CPlusPlus.html#stl-types"). A common pattern is to use
...
### The conversion isn’t free[¶](#the-conversion-isn-t-free "Link to this heading")
...
### Changes do not propagate back[¶](#changes-do-not-propagate-back "Link to this heading")
...
* [Troubleshooting](# "#")
  + [Where the language is “messy”](#where-the-language-is-messy "#where-the-language-is-messy")
  + [`AttributeErrors`](#attributeerrors "#attributeerrors")
    - [Untyped objects](#untyped-objects "#untyped-objects")
    - [Writing into extension types](#writing-into-extension-types "#writing-into-extension-types")
  + [Extension type class attributes vs instance attributes](#extension-type-class-attributes-vs-instance-attributes "#extension-type-class-attributes-vs-instance-attributes")
  + [Pitfalls of automatic type conversions](#pitfalls-of-automatic-type-conversions "#pitfalls-of-automatic-type-conversions")
    - [The conversion isn’t free](#the-conversion-isn-t-free "#the-conversion-isn-t-free")
    - [Changes do not propagate back](#changes-do-not-propagate-back "#changes-do-not-propagate-back")

#### Previous topic

[Tempita templating language](tempita.html "previous chapter")

#### Next topic

[FAQ](faq.html "next chapter")

### This Page

* [Show Source](../../_sources/src/userguide/troubleshooting.rst.txt "../../_sources/src/userguide/troubleshooting.rst.txt")
