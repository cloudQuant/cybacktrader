...
FAQ — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/faq.html "/en/stable/src/userguide/faq.html").

### Navigation

* [next](glossary.html "Glossary")
* [previous](troubleshooting.html "Troubleshooting") |
...
### Do I need to rename my `.py` file to `.pyx`?[¶](#do-i-need-to-rename-my-py-file-to-pyx "Link to this heading")
...
But you can use Cython’s [pure Python mode](../tutorial/pure.html#pure-mode "../tutorial/pure.html#pure-mode") to provide type declarations for the compilation, including Python’s PEP-484 syntax for type hints.
...
### Can Cython generate C code for classes?[¶](#can-cython-generate-c-code-for-classes "Link to this heading")
...
### Can I call my Python code from C?[¶](#can-i-call-my-python-code-from-c "Link to this heading")

Answer: Yes, easily. Follow the example in [Demos/callback/](https://github.com/cython/cython/tree/master/Demos/callback "https://github.com/cython/cython/tree/master/Demos/callback") in the Cython source distribution.

### How do I interface numpy arrays using Cython?[¶](#how-do-i-interface-numpy-arrays-using-cython "Link to this heading")

Answer: Follow the [example](numpy_tutorial.html#numpy-tutorial "numpy_tutorial.html#numpy-tutorial").

### How do I compile Cython with subpackages?[¶](#how-do-i-compile-cython-with-subpackages "Link to this heading")
...
### How do I speed up the C compilation?[¶](#how-do-i-speed-up-the-c-compilation "Link to this heading")
...
### How do I reduce the size of the binary modules?[¶](#how-do-i-reduce-the-size-of-the-binary-modules "Link to this heading")
...
* If you do not need to expose the docstrings of Python functions and classes,
  ...
  [`Cython.Compiler.Options.docstrings`](source_files_and_compilation.html#Cython.Compiler.Options.docstrings "Cython.Compiler.Options.docstrings").
* If you use memoryviews in multiple modules, you can generate and use a shared utility module.
  ...
  instead of having them replicated in every module. See [Shared utility module](source_files_and_compilation.html#shared-module "source_files_and_compilation.html#shared-module") for more detail.

### How well is Unicode supported?[¶](#how-well-is-unicode-supported "Link to this heading")
...
See the [string tutorial](../tutorial/strings.html#string-tutorial "../tutorial/strings.html#string-tutorial").

## How do I …?[¶](#how-do-i "Link to this heading")

### How do I pickle cdef classes?[¶](#how-do-i-pickle-cdef-classes "Link to this heading")

Answer: See [the documentation](extension_types.html#auto-pickle "extension_types.html#auto-pickle").

### How do I help Cython find numpy header files?[¶](#how-do-i-help-cython-find-numpy-header-files "Link to this heading")
...
### How do I declare numeric or integer C types?[¶](#how-do-i-declare-numeric-or-integer-c-types "Link to this heading")
...
### How do I declare an object of type bool?[¶](#how-do-i-declare-an-object-of-type-bool "Link to this heading")
...
### How do I use `const`?[¶](#how-do-i-use-const "Link to this heading")

Answer: You can just use it in your code and in your declarations.

### How do I use builtins like `len()` with the C type `char *`?[¶](#how-do-i-use-builtins-like-len-with-the-c-type-char "Link to this heading")
...
### How do I make a cdef’d class that derives from a builtin Python type such as list?[¶](#how-do-i-make-a-cdef-d-class-that-derives-from-a-builtin-python-type-such-as-list "Link to this heading")
...
[bug](https://github.com/cython/cython/issues/711 "https://github.com/cython/cython/issues/711"). However, you can
safely subtype ‘unicode’ and ‘list’ instead.

### How do I raise an exception in Cython code that will be visible to ancestor (in the callstack) CPython code?[¶](#how-do-i-raise-an-exception-in-cython-code-that-will-be-visible-to-ancestor-in-the-callstack-cpython-code "Link to this heading")
...
[Error return values](language_basics.html#error-return-values "language_basics.html#error-return-values").

### How do I declare a global variable?[¶](#how-do-i-declare-a-global-variable "Link to this heading")
...
### How do I assign to a global variable?[¶](#how-do-i-assign-to-a-global-variable "Link to this heading")
...
See [http://docs.python.org/tutorial/classes.html#python-scopes-and-namespaces](http://docs.python.org/tutorial/classes.html#python-scopes-and-namespaces "http://docs.python.org/tutorial/classes.html#python-scopes-and-namespaces")
for more details.

### How do I create objects or apply operators to locally created objects as pure C code?[¶](#how-do-i-create-objects-or-apply-operators-to-locally-created-objects-as-pure-c-code "Link to this heading")
...
### How do I implement a single class method in a Cython module?[¶](#how-do-i-implement-a-single-class-method-in-a-cython-module "Link to this heading")
...
### How do I pass string buffers that may contain 0 bytes to Cython?[¶](#how-do-i-pass-string-buffers-that-may-contain-0-bytes-to-cython "Link to this heading")

Answer: See the [string tutorial](../tutorial/strings.html#string-tutorial "../tutorial/strings.html#string-tutorial").
...
### How do I pass a Python string parameter on to a C library?[¶](#how-do-i-pass-a-python-string-parameter-on-to-a-c-library "Link to this heading")

See the string tutorial <string\_tutorial>.
...
### How do I use variable args?[¶](#how-do-i-use-variable-args "Link to this heading")
...
### How do I make a standalone binary from a Python program using cython?[¶](#how-do-i-make-a-standalone-binary-from-a-python-program-using-cython "Link to this heading")
...
More details can be found [in the embedding documentation](../tutorial/embedding.html#embedding "../tutorial/embedding.html#embedding").

### How do I have to wrap C code that uses the restrict qualifier?[¶](#how-do-i-have-to-wrap-c-code-that-uses-the-restrict-qualifier "Link to this heading")
...
#### slurp.h[¶](#slurp-h "Link to this heading")
...
#### cslurp.c[¶](#cslurp-c "Link to this heading")
...
#### slurp.pyx[¶](#slurp-pyx "Link to this heading")
...
### How do I automatically generate Cython definition files from C (.h) or C++ (.hpp) header files ?[¶](#how-do-i-automatically-generate-cython-definition-files-from-c-h-or-c-hpp-header-files "Link to this heading")
...
[http://github.com/uweschmitt/autowrap](http://github.com/uweschmitt/autowrap "http://github.com/uweschmitt/autowrap")

python-autopxd

Automatically generate pxd from C headers. It uses
[pycparser]([https://github.com/eliben/pycparser](https://github.com/eliben/pycparser "https://github.com/eliben/pycparser")) to parse the definitions, so
the only requirement beyond python dependencies is a C preprocessor on PATH.

[https://github.com/gabrieldemarmiesse/python-autopxd2](https://github.com/gabrieldemarmiesse/python-autopxd2 "https://github.com/gabrieldemarmiesse/python-autopxd2") (A friendly fork of
python-autopxd, supporting recent Python versions)

[https://github.com/tarruda/python-autopxd](https://github.com/tarruda/python-autopxd "https://github.com/tarruda/python-autopxd") (original version)

### How do I run doctests in Cython code (pyx files)?[¶](#how-do-i-run-doctests-in-cython-code-pyx-files "Link to this heading")
...
### How do I work around the `-Wno-long-double error` when installing on OS X?[¶](#how-do-i-work-around-the-wno-long-double-error-when-installing-on-os-x "Link to this heading")
...
### How do I work around the “unable to find vcvarsall.bat” error when using MinGW as the compiler (on Windows)?[¶](#how-do-i-work-around-the-unable-to-find-vcvarsall-bat-error-when-using-mingw-as-the-compiler-on-windows "Link to this heading")
...
### What is the difference between a `.pxd` and `.pxi` file? When should either be used?[¶](#what-is-the-difference-between-a-pxd-and-pxi-file-when-should-either-be-used "Link to this heading")
...
### What is better, a single big module or multiple separate modules?[¶](#what-is-better-a-single-big-module-or-multiple-separate-modules "Link to this heading")
...
can be parallelised. The “build\_ext” command in distutils has a “-j” option
...
[feature request](https://github.com/cython/cython/issues/2356 "https://github.com/cython/cython/issues/2356") that would mitigate
this.
...
### What is the difference between `PyObject*` and `object`?[¶](#what-is-the-difference-between-pyobject-and-object "Link to this heading")
...
### Why does Cython not always give errors for uninitialized variables?[¶](#why-does-cython-not-always-give-errors-for-uninitialized-variables "Link to this heading")
...
### Why does a function with cdef’d parameters accept None?[¶](#why-does-a-function-with-cdef-d-parameters-accept-none "Link to this heading")
...
### Is Cython a Python implementation?[¶](#is-cython-a-python-implementation "Link to this heading")
...
### Is Cython faster than CPython?[¶](#is-cython-faster-than-cpython "Link to this heading")
...
### What Python versions does Cython support?[¶](#what-python-versions-does-cython-support "Link to this heading")
...
### What’s the license situation of Cython’s output?[¶](#what-s-the-license-situation-of-cython-s-output "Link to this heading")
...
### How do I cite Cython in an academic paper?[¶](#how-do-i-cite-cython-in-an-academic-paper "Link to this heading")
...
paper](https://www.computer.org/csdl/magazine/cs/2011/02/mcs2011020031/13rRUx0Pqtw|journalpaper "https://www.computer.org/csdl/magazine/cs/2011/02/mcs2011020031/13rRUx0Pqtw|journalpaper") on Cython.
...
### What is the relation between Cython and Pyrex?[¶](#what-is-the-relation-between-cython-and-pyrex "Link to this heading")
...
* [FAQ](# "#")
  + [Basics](#basics "#basics")
    - [Do I need to rename my `.py` file to `.pyx`?](#do-i-need-to-rename-my-py-file-to-pyx "#do-i-need-to-rename-my-py-file-to-pyx")
    - [Can Cython generate C code for classes?](#can-cython-generate-c-code-for-classes "#can-cython-generate-c-code-for-classes")
    - [Can I call my Python code from C?](#can-i-call-my-python-code-from-c "#can-i-call-my-python-code-from-c")
    - [How do I interface numpy arrays using Cython?](#how-do-i-interface-numpy-arrays-using-cython "#how-do-i-interface-numpy-arrays-using-cython")
    - [How do I compile Cython with subpackages?](#how-do-i-compile-cython-with-subpackages "#how-do-i-compile-cython-with-subpackages")
    - [How do I speed up the C compilation?](#how-do-i-speed-up-the-c-compilation "#how-do-i-speed-up-the-c-compilation")
    - [How do I reduce the size of the binary modules?](#how-do-i-reduce-the-size-of-the-binary-modules "#how-do-i-reduce-the-size-of-the-binary-modules")
    - [How well is Unicode supported?](#how-well-is-unicode-supported "#how-well-is-unicode-supported")
  + [How do I …?](#how-do-i "#how-do-i")
    - [How do I pickle cdef classes?](#how-do-i-pickle-cdef-classes "#how-do-i-pickle-cdef-classes")
    - [How do I help Cython find numpy header files?](#how-do-i-help-cython-find-numpy-header-files "#how-do-i-help-cython-find-numpy-header-files")
    - [How do I declare numeric or integer C types?](#how-do-i-declare-numeric-or-integer-c-types "#how-do-i-declare-numeric-or-integer-c-types")
    - [How do I declare an object of type bool?](#how-do-i-declare-an-object-of-type-bool "#how-do-i-declare-an-object-of-type-bool")
    - [How do I use `const`?](#how-do-i-use-const "#how-do-i-use-const")
    - [How do I use builtins like `len()` with the C type `char *`?](#how-do-i-use-builtins-like-len-with-the-c-type-char "#how-do-i-use-builtins-like-len-with-the-c-type-char")
    - [How do I make a cdef’d class that derives from a builtin Python type such as list?](#how-do-i-make-a-cdef-d-class-that-derives-from-a-builtin-python-type-such-as-list "#how-do-i-make-a-cdef-d-class-that-derives-from-a-builtin-python-type-such-as-list")
    - [How do I raise an exception in Cython code that will be visible to ancestor (in the callstack) CPython code?](#how-do-i-raise-an-exception-in-cython-code-that-will-be-visible-to-ancestor-in-the-callstack-cpython-code "#how-do-i-raise-an-exception-in-cython-code-that-will-be-visible-to-ancestor-in-the-callstack-cpython-code")
    - [How do I declare a global variable?](#how-do-i-declare-a-global-variable "#how-do-i-declare-a-global-variable")
    - [How do I assign to a global variable?](#how-do-i-assign-to-a-global-variable "#how-do-i-assign-to-a-global-variable")
    - [How do I create objects or apply operators to locally created objects as pure C code?](#how-do-i-create-objects-or-apply-operators-to-locally-created-objects-as-pure-c-code "#how-do-i-create-objects-or-apply-operators-to-locally-created-objects-as-pure-c-code")
    - [How do I implement a single class method in a Cython module?](#how-do-i-implement-a-single-class-method-in-a-cython-module "#how-do-i-implement-a-single-class-method-in-a-cython-module")
    - [How do I pass string buffers that may contain 0 bytes to Cython?](#how-do-i-pass-string-buffers-that-may-contain-0-bytes-to-cython "#how-do-i-pass-string-buffers-that-may-contain-0-bytes-to-cython")
    - [How do I pass a Python string parameter on to a C library?](#how-do-i-pass-a-python-string-parameter-on-to-a-c-library "#how-do-i-pass-a-python-string-parameter-on-to-a-c-library")
    - [How do I use variable args?](#how-do-i-use-variable-args "#how-do-i-use-variable-args")
    - [How do I make a standalone binary from a Python program using cython?](#how-do-i-make-a-standalone-binary-from-a-python-program-using-cython "#how-do-i-make-a-standalone-binary-from-a-python-program-using-cython")
    - [How do I have to wrap C code that uses the restrict qualifier?](#how-do-i-have-to-wrap-c-code-that-uses-the-restrict-qualifier "#how-do-i-have-to-wrap-c-code-that-uses-the-restrict-qualifier")
      * [slurp.h](#slurp-h "#slurp-h")
      * [cslurp.c](#cslurp-c "#cslurp-c")
      * [slurp.pyx](#slurp-pyx "#slurp-pyx")
    - [How do I automatically generate Cython definition files from C (.h) or C++ (.hpp) header files ?](#how-do-i-automatically-generate-cython-definition-files-from-c-h-or-c-hpp-header-files "#how-do-i-automatically-generate-cython-definition-files-from-c-h-or-c-hpp-header-files")
    - [How do I run doctests in Cython code (pyx files)?](#how-do-i-run-doctests-in-cython-code-pyx-files "#how-do-i-run-doctests-in-cython-code-pyx-files")
    - [How do I work around the `-Wno-long-double error` when installing on OS X?](#how-do-i-work-around-the-wno-long-double-error-when-installing-on-os-x "#how-do-i-work-around-the-wno-long-double-error-when-installing-on-os-x")
    - [How do I work around the “unable to find vcvarsall.bat” error when using MinGW as the compiler (on Windows)?](#how-do-i-work-around-the-unable-to-find-vcvarsall-bat-error-when-using-mingw-as-the-compiler-on-windows "#how-do-i-work-around-the-unable-to-find-vcvarsall-bat-error-when-using-mingw-as-the-compiler-on-windows")
  + [Explanations](#explanations "#explanations")
    - [What is the difference between a `.pxd` and `.pxi` file? When should either be used?](#what-is-the-difference-between-a-pxd-and-pxi-file-when-should-either-be-used "#what-is-the-difference-between-a-pxd-and-pxi-file-when-should-either-be-used")
    - [What is better, a single big module or multiple separate modules?](#what-is-better-a-single-big-module-or-multiple-separate-modules "#what-is-better-a-single-big-module-or-multiple-separate-modules")
    - [What is the difference between `PyObject*` and `object`?](#what-is-the-difference-between-pyobject-and-object "#what-is-the-difference-between-pyobject-and-object")
    - [Why does Cython not always give errors for uninitialized variables?](#why-does-cython-not-always-give-errors-for-uninitialized-variables "#why-does-cython-not-always-give-errors-for-uninitialized-variables")
    - [Why does a function with cdef’d parameters accept None?](#why-does-a-function-with-cdef-d-parameters-accept-none "#why-does-a-function-with-cdef-d-parameters-accept-none")
  + [About the project](#about-the-project "#about-the-project")
    - [Is Cython a Python implementation?](#is-cython-a-python-implementation "#is-cython-a-python-implementation")
    - [Is Cython faster than CPython?](#is-cython-faster-than-cpython "#is-cython-faster-than-cpython")
    - [What Python versions does Cython support?](#what-python-versions-does-cython-support "#what-python-versions-does-cython-support")
    - [What’s the license situation of Cython’s output?](#what-s-the-license-situation-of-cython-s-output "#what-s-the-license-situation-of-cython-s-output")
    - [How do I cite Cython in an academic paper?](#how-do-i-cite-cython-in-an-academic-paper "#how-do-i-cite-cython-in-an-academic-paper")
    - [What is the relation between Cython and Pyrex?](#what-is-the-relation-between-cython-and-pyrex "#what-is-the-relation-between-cython-and-pyrex")

#### Previous topic

[Troubleshooting](troubleshooting.html "previous chapter")
...
* [Show Source](../../_sources/src/userguide/faq.rst.txt "../../_sources/src/userguide/faq.rst.txt")
