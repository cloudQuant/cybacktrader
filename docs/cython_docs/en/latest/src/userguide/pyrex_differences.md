...
Differences between Cython and Pyrex — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/pyrex_differences.html "/en/stable/src/userguide/pyrex_differences.html").
...
the [`for`](https://docs.python.org/3/reference/compound_stmts.html#for "(in Python v3.14)") … [`from`](https://docs.python.org/3/reference/simple_stmts.html#from "(in Python v3.14)") syntax, too, but it is
generally preferred to use the usual [`for`](https://docs.python.org/3/reference/compound_stmts.html#for "(in Python v3.14)") … [`in`](https://docs.python.org/3/reference/expressions.html#in "(in Python v3.14)")
...
normal Python [`for`](https://docs.python.org/3/reference/compound_stmts.html#for "(in Python v3.14)") loop.
See [Automatic range conversion](#automatic-range-conversion "#automatic-range-conversion").
...
Including a working [`classmethod()`](https://docs.python.org/3/library/functions.html#classmethod "(in Python v3.14)"):
...
Cython adds a third function type on top of the usual [`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.14)") and
...
[`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.14)") method that does nothing but call the underlying
...
[`isinstance()`](https://docs.python.org/3/library/functions.html#isinstance "(in Python v3.14)") is used with an extension type as the second parameter.
