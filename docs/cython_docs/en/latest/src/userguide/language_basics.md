...
Language Basics — Cython 3.2.0b1 documentation
...
[here](/en/stable/src/userguide/language_basics.html "/en/stable/src/userguide/language_basics.html").
...
values for False/True) and [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.14)") for (signed) sizes of Python
containers.
...
For declared builtin types, Cython uses internally a C variable of type [PyObject](https://docs.python.org/3/c-api/structures.html#c.PyObject "(in Python v3.14)")\*.
...
Python functions are defined using the [`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.14)") statement, as in Python. They take
...
To create a borrowed reference, specify the parameter type as [PyObject](https://docs.python.org/3/c-api/structures.html#c.PyObject "(in Python v3.14)")\*.
Cython won’t perform automatic [`Py_INCREF()`](https://docs.python.org/3/c-api/refcounting.html#c.Py_INCREF "(in Python v3.14)"), or [`Py_DECREF()`](https://docs.python.org/3/c-api/refcounting.html#c.Py_DECREF "(in Python v3.14)"), e.g.:
...
or implicitly return that value. This includes empty [`return`](https://docs.python.org/3/reference/simple_stmts.html#return "(in Python v3.14)")
...
In this case, Cython generates a call to [`PyErr_Occurred()`](https://docs.python.org/3/c-api/exceptions.html#c.PyErr_Occurred "(in Python v3.14)") if the exception value
...
This form causes Cython to generate a call to [`PyErr_Occurred()`](https://docs.python.org/3/c-api/exceptions.html#c.PyErr_Occurred "(in Python v3.14)") after
...
* If the returning type of a `cdef` function with `except *` or `@cython.exceptval(check=True)` is C integer,
  enum, float or pointer type, Cython calls [`PyErr_Occurred()`](https://docs.python.org/3/c-api/exceptions.html#c.PyErr_Occurred "(in Python v3.14)") only when
...
perform a [`Py_INCREF()`](https://docs.python.org/3/c-api/refcounting.html#c.Py_INCREF "(in Python v3.14)") and [`Py_DECREF()`](https://docs.python.org/3/c-api/refcounting.html#c.Py_DECREF "(in Python v3.14)") operation. Casting to
...
corresponding to the three-argument form of the Python builtin [`getattr()`](https://docs.python.org/3/library/functions.html#getattr "(in Python v3.14)").
...
returned by [`os.uname()`](https://docs.python.org/3/library/os.html#os.uname "(in Python v3.14)"). As noted above, they are not considered good ways
