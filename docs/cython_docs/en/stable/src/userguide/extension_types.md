...
Extension Types — Cython 3.1.4 documentation
...
class definition. Within it, you use the [`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.13)") statement to define methods that
...
rather than raising an [`AttributeError`](https://docs.python.org/3/library/exceptions.html#AttributeError "(in Python v3.13)"), either an nonsensical result will be
...
which performs a type check (possibly raising a [`TypeError`](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)")) before making the
...
[`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.13)") and without `@cython.cfunc` decorator) and not C functions
...
* [`cdef`](language_basics.html#cdef "language_basics.html#cdef") instead of [`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.13)") or `@cfunc` decorator for C methods, or
* [`cpdef`](language_basics.html#cpdef "language_basics.html#cpdef") instead of [`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.13)") or `@ccall` decorator for hybrid methods.
...
a [`TypeError`](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)") at runtime. Cython will also prevent subtyping a
...
so it is deallocated. This is done using the [`PyTypeObject.tp_dealloc`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_dealloc "(in Python v3.13)") slot, which can be
...
(using the [`PyTypeObject.tp_traverse`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_traverse "(in Python v3.13)") slot) and break it.
...
objects from memory. Clearing is implemented in the [`PyTypeObject.tp_clear`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_clear "(in Python v3.13)") slot.
As we just explained, it is sufficient that one object in the cycle
implements [`PyTypeObject.tp_clear`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_clear "(in Python v3.13)").
...
generate the [`PyTypeObject.tp_traverse`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_traverse "(in Python v3.13)") and [`PyTypeObject.tp_clear`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_clear "(in Python v3.13)") slots. This is usually what you
want.
...
have triggered a call to [`PyTypeObject.tp_clear`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_clear "(in Python v3.13)") to clear the object
...
1. In this example, [`ctypedef`](language_basics.html#ctypedef "language_basics.html#ctypedef") class has been used. This is
   ...
   c-extension module that `__builtin__.complex`’s [`PyTypeObject.tp_basicsize`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_basicsize "(in Python v3.13)")
...
* `cs_option` is `warn` (the default), `error`, or `ignore` and is only
  ...
  that was found at compile time must match the type’s runtime [`PyTypeObject.tp_basicsize`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_basicsize "(in Python v3.13)")
  ...
  [`PyTypeObject.tp_basicsize`](https://docs.python.org/3/c-api/typeobj.html#c.PyTypeObject.tp_basicsize "(in Python v3.13)"), which indicates the runtime type may be part of an updated
...
different labels for the fields than those in the [`PyTypeObject`](https://docs.python.org/3/c-api/type.html#c.PyTypeObject "(in Python v3.13)"). This can
