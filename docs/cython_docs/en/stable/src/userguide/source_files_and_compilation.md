...
Source Files and Compilation — Cython 3.1.4 documentation
...
and `kwds` is a [`dict`](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.13)") with all keywords which should be used
...
with [`Py_Initialize()`](https://docs.python.org/3/c-api/init.html#c.Py_Initialize "(in Python v3.13)"), you need to initialise the modules at runtime
using the [`PyImport_AppendInittab()`](https://docs.python.org/3/c-api/import.html#c.PyImport_AppendInittab "(in Python v3.13)") C-API function, again inserting
...
(e.g. [`len()`](https://docs.python.org/3/library/functions.html#len "(in Python v3.13)")) or, when set to True, more like Python’s functions.
...
Python 3.7 upwards.
Note that this is a [`Python macro`](https://docs.python.org/3/c-api/stable.html#c.Py_LIMITED_API "(in Python v3.13)"),
...
Defines `cdef class`es as [Heap Types](https://docs.python.org/3/c-api/typeobj.html#heap-types "(in Python v3.13)") rather than
...
[`gc.get_referents()`](https://docs.python.org/3/library/gc.html#gc.get_referents "(in Python v3.13)").
