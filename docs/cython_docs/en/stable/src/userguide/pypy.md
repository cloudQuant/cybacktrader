...
Porting Cython code to PyPy — Cython 3.1.4 documentation
...
borrowed references, e.g. [`PyTuple_GET_ITEM()`](https://docs.python.org/3/c-api/tuple.html#c.PyTuple_GET_ITEM "(in Python v3.13)") and similar functions,
...
to [`Py_INCREF()`](https://docs.python.org/3/c-api/refcounting.html#c.Py_INCREF "(in Python v3.13)") when getting the reference and [`Py_DECREF()`](https://docs.python.org/3/c-api/refcounting.html#c.Py_DECREF "(in Python v3.13)")
...
form of their C level representation: [`PyComplexObject`](https://docs.python.org/3/c-api/complex.html#c.PyComplexObject "(in Python v3.13)"),
[`PyFloatObject`](https://docs.python.org/3/c-api/float.html#c.PyFloatObject "(in Python v3.13)") and `PyBoolObject`.
...
of [`PyLongObject`](https://docs.python.org/3/c-api/long.html#c.PyLongObject "(in Python v3.13)") or the `allocated` field of the
[`PyListObject`](https://docs.python.org/3/c-api/list.html#c.PyListObject "(in Python v3.13)") struct etc. Although the `ob_size` field of
containers (used by the [`Py_SIZE()`](https://docs.python.org/3/c-api/structures.html#c.Py_SIZE "(in Python v3.13)") macro) is available, it is
...
Currently, the GIL handling function [`PyGILState_Ensure()`](https://docs.python.org/3/c-api/init.html#c.PyGILState_Ensure "(in Python v3.13)") is not
...
pointer in CPython. A visible example is [`PyTuple_GET_ITEM()`](https://docs.python.org/3/c-api/tuple.html#c.PyTuple_GET_ITEM "(in Python v3.13)").

Some more high-level functions may also show entirely different performance
characteristics, e.g. [`PyDict_Next()`](https://docs.python.org/3/c-api/dict.html#c.PyDict_Next "(in Python v3.13)") for dict iteration. While
