...
Interfacing with External C Code — Cython 3.1.4 documentation
...
Cython predefines the name [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.13)") for use with Python/C API routines. To
...
In this case, make sure to call [`Py_Initialize()`](https://docs.python.org/3/c-api/init.html#c.Py_Initialize "(in Python v3.13)") and [`Py_Finalize()`](https://docs.python.org/3/c-api/init.html#c.Py_Finalize "(in Python v3.13)").
...
[`Py_Initialize()`](https://docs.python.org/3/c-api/init.html#c.Py_Initialize "(in Python v3.13)") and [`Py_Finalize()`](https://docs.python.org/3/c-api/init.html#c.Py_Finalize "(in Python v3.13)"); if you experience a segmentation fault in
