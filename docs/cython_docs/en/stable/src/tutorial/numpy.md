...
Working with NumPy — Cython 3.1.4 documentation
...
i.e. use [`object`](https://docs.python.org/3/library/functions.html#object "(in Python v3.13)") rather than `cnp.ndarray`. Under Python 3.0 this
