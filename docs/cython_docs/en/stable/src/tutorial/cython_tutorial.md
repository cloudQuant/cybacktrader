...
Basic Tutorial — Cython 3.1.4 documentation
...
[blog post](https://shahriar.svbtle.com/pythons-else-clause-in-loops "https://shahriar.svbtle.com/pythons-else-clause-in-loops").
