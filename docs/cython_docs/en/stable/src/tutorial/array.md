...
Working with Python arrays — Cython 3.1.4 documentation
...
[`multiprocessing`](https://docs.python.org/3/library/multiprocessing.html#module-multiprocessing "(in Python v3.13)").
...
Numpy array there is no need to install a dependency, as the [`array`](https://docs.python.org/3/library/array.html#module-array "(in Python v3.13)")
