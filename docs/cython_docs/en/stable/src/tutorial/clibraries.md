...
Using C libraries — Cython 3.1.4 documentation
...
queue.h[¶](#id11 "Link to this code")
...
cqueue.pxd[¶](#id12 "Link to this code")
...
Here, [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.13)"):
...
to a smaller integer type without checking the boundaries, and [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.13)")
...
an `int`, so the above conversion from void\* to [`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.13)") to `int`
...
[:c:function:`PyErr\_Occurred()`](#id9 "#id9") when returning from a function to check if an
...
queue.py[¶](#id17 "Link to this code")
...
queue.pyx[¶](#id18 "Link to this code")
