...
Pure Python Mode — Cython 3.1.4 documentation
...
Normal Python ([`def`](https://docs.python.org/3/reference/compound_stmts.html#def "(in Python v3.13)")) functions cannot be declared in `.pxd`
...
[`Py_ssize_t`](https://docs.python.org/3/c-api/intro.html#c.Py_ssize_t "(in Python v3.13)") for (signed) sizes of Python containers.
