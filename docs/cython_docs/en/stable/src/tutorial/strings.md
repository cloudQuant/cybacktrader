...
Unicode and passing strings — Cython 3.1.4 documentation
...
Cython supports four Python string types: [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)"), [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"),
`unicode` and `basestring`. The [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") and `unicode` types
are the specific types known from normal Python 2.x (named [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)")
and [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") in Python 3). Additionally, Cython also supports the
[`bytearray`](https://docs.python.org/3/library/stdtypes.html#bytearray "(in Python v3.13)") type which behaves like the [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") type, except
that it is mutable.

The [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") type is special in that it is the byte string in Python 2
...
exactly with the type that the Python runtime itself calls [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)").
Thus, in Python 2, both [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") and [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") represent the byte string
type, whereas in Python 3, both [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") and `unicode` represent the
...
When compiling Cython code with language level 3, the [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") type is
identified with exactly the Unicode string type at Cython compile time,
i.e. it does not identify with [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") when running in Python 2.

Note that the [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") type is not compatible with the `unicode`
type in Python 2, i.e. you cannot assign a Unicode string to a variable
or argument that is typed [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"). The attempt will result in either
a compile time error (if detectable) or a [`TypeError`](https://docs.python.org/3/library/exceptions.html#TypeError "(in Python v3.13)") exception at
...
[`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") or `unicode`.

The `basestring` type represents both the types [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") and `unicode`,
...
least in Python 3) but must additionally accept the [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") type in
Python 2 for backwards compatibility reasons. It is not compatible with
the [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") type. Its usage should be rare in normal Cython code as
the generic [`object`](https://docs.python.org/3/library/functions.html#object "(in Python v3.13)") type (i.e. untyped code) will normally be good
...
Unprefixed string literals become [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") objects when compiling
with language level 2 and [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") objects
...
A type cast to [`object`](https://docs.python.org/3/library/functions.html#object "(in Python v3.13)") or [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") will do the same thing:
...
Starting with Cython 0.20, the [`bytearray`](https://docs.python.org/3/library/stdtypes.html#bytearray "(in Python v3.13)") type is supported and
coerces in the same way as the [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") type. However, when using it
...
something like [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)"), because that would restrict the allowed
input to exactly that type and exclude both subtypes and other kinds
of byte containers, e.g. [`bytearray`](https://docs.python.org/3/library/stdtypes.html#bytearray "(in Python v3.13)") objects or memory views.
...
a flat and simple [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") or [`bytearray`](https://docs.python.org/3/library/stdtypes.html#bytearray "(in Python v3.13)") object, especially
...
For read-only buffers, like [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)"), the memoryview item type should
...
expects that it can pass a byte string ([`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")) with encoded text into
...
[`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") literal `'abcö'` will become a byte string in Python 2 (thus
...
As a rule of thumb, it is best to avoid unprefixed non-ASCII [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
the parser to read all unprefixed [`str`](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") literals in a source file as
...
point value, i.e. a single Unicode character: [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)")
and [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)"). Cython supports the
first natively, support for [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)") is new in Cython 0.15.
[`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") is either defined as an unsigned 2-byte or
...
compile time. The advantage of [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)") is that it is
...
[`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") and [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)") types when coercing
...
[`OverflowError`](https://docs.python.org/3/library/exceptions.html#OverflowError "(in Python v3.13)") at runtime. Coercion will also happen automatically
...
On the other hand, the [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") and [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)")
...
code with the [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") type:
...
[`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") type. For example, such a CPython build will
...
However, programmers should be aware that a single [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)")
...
the full [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)") range even on narrow platforms:
...
In CPython 3.3 and later, the [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") type is an alias
...
[`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)"). See [PEP 393](https://peps.python.org/pep-0393/ "https://peps.python.org/pep-0393/") for details.
...
is applied to untyped variables or the portable [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)") type
is explicitly used in the source code instead of the platform specific
[`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") type. Optimisations that Cython applies to the
...
loop variable as [`Py_UCS4`](https://docs.python.org/3/c-api/unicode.html#c.Py_UCS4 "(in Python v3.13)"):
...
strongly discouraged. [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") is inherently not
...
unicode strings ([PEP 393](https://peps.python.org/pep-0393/ "https://peps.python.org/pep-0393/")), that makes all [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") related
...
By default, Windows builds of CPython define [`Py_UNICODE`](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)") as
...
strings (in the form of [Py\_UNICODE](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)")\*) and implicitly converts
them to and from `unicode` string objects. These conversions behave the
same way as they do for char\* and [`bytes`](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.13)") as described in
...
in C context become C-level wide string literals and [`len()`](https://docs.python.org/3/library/functions.html#len "(in Python v3.13)")
built-in function is specialized to compute the length of zero-terminated
[Py\_UNICODE](https://docs.python.org/3/c-api/unicode.html#c.Py_UNICODE "(in Python v3.13)")\* string or array.
...
One consequence of CPython 3.3 changes is that [`len()`](https://docs.python.org/3/library/functions.html#len "(in Python v3.13)") of
